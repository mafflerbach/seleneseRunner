...
class Setup {
  ...
  public function __construct($profile, $args) {
  ...
  public function init() {
    ...
    if(!isset($this->args['testonaut']['local']) ||  $this->args['testonaut']['local'] == 1 ) {
      $hubAddre = $this->hub;
    } else {
      $hubAddre = $this->args['testonaut']['saucelabs']['username'] . ":" .
          $this->args['testonaut']['saucelabs']['access_key'] . '@' .
          $this->args['testonaut']['saucelabs']['hub'] . '/wd/hub';
      $this->local = FALSE;
    }
  ...
  public function getCapabilities() {
    ...
    if (isset($this->profile['name'])) {
      $browserName = $this->normalizeBrowserName($this->profile['name']);
    }
